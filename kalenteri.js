var cal = {
    ...
    show : function (el) {
      ...
      // (C2) DRAW EVENT FORM
      var tForm = "<h1>" + (cal.data[cal.sDay] ? "Muokkaa" : "Lisää") + " Tapahtuma</h1>";
      ...
      tForm += "<input type='button' value='Sulje' onclick='cal.close()'/>";
      tForm += "<input type='button' value='Poista' onclick='cal.del()'/>";
      tForm += "<input type='submit' value='Tallenna'/>";
